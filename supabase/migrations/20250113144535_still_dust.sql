-- Drop the payment_method_type enum and constraints
ALTER TABLE transactions 
  ALTER COLUMN payment_method TYPE text;

-- Update trigger to validate payment method exists
...
-- Update existing transactions to use default payment method if invalid
